...
st.set_page_config(
   ...
   page_icon=r'C:\Users\Documents\Desktop\Resume\Logo\logo rsume parser.png',
)
def run():
    img = Image.open(r'C:\Users\Documents\Desktop\Resume\Logo\logo rsume parser.png')
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            resume_data = ResumeParser(save_image_path, skills_file=None, custom_regex=None).get_extracted_data()
            ...
            if resume_data:
                ...
                name = resume_data.get('name', 'User') or 'User'  
